      ...
      <div style={{ backgroundColor: '#a47174', minHeight: '100vh' }}>
        ...
        <div className="div-contenedorBis">
          ...
          <ul className="blog-text">
            <li><strong>Escribir aunque no tenga sentido</strong>. A veces solo necesito volcar todo en un bloc de notas, aunque después lo borre o me dé cringe reconocer.</li>
            <li><strong>Caminar sin auriculares</strong>. Escuchar mis pasos, la ciudad y lo que pasa alrededor te conecta con lo que sos. Especialmente si trabajás remoto y no soportás las cuatro paredes y la pantalla.</li>
            <li><strong>Dejar de romantizar el pasado</strong>. Una relación a distancia también duele, incluso cuando funciona. No todo era amor, también había frustración, ansiedad y muchas dudas. (jaja) Todo para no decir que ya no nos soportábamos. Solo recordás cuando se reían y se iban de vacaciones, no los proyectos y peleas interminables. (SIGO DOLIDA, ES MI BLOG. ESCUCHAMOS PERO NO JUZGAMOS, gracias)</li>
            <li><strong>Meditar 5 minutos (ahre)</strong>. Medio random pero funciona, a veces disocio un poco pero te enfoca y regula. Te recomiendo: <a href="https://www.youtube.com/playlist?list=PLS2RRDvDmjhQ4r9vI3ydlDF9YcpdXN38G" target="_blank" rel="noopener noreferrer">estas guías breves de meditación</a>.</li>
          ...
          <p className="blog-text">
            A veces el silencio se vuelve ruido. Y ahí es donde a algunas personas les sirve jugar. No es mi caso, pero acá reconocemos todas las posibilidades.
          </p>
          <ul className="blog-text">
